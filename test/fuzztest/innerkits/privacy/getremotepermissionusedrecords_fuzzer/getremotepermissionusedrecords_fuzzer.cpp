...
#include "getremotepermissionusedrecords_fuzzer.h"
...
namespace OHOS {
bool GetRemotePermissionUsedRecordsFuzzTest(const uint8_t* data, size_t size)
{
    ...
    return PrivacyKit::GetRemotePermissionUsedRecords(request, res) == 0;
}
}
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::GetRemotePermissionUsedRecordsFuzzTest(data, size);
    return 0;
}
