...
#include "setpermissionstatuswithpolicy_fuzzer.h"
...
namespace OHOS {
    bool SetPermissionStatusWithPolicyFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::SetPermissionStatusWithPolicyFuzzTest(data, size);
    return 0;
}
