...
#include "revokeusergrantedpermission_fuzzer.h"
...
namespace OHOS {
    bool RevokeUserGrantedPermissionFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        return AccessTokenKit::RevokePermission(tokenId, permission, flag) == RET_SUCCESS;
    }
}
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::RevokeUserGrantedPermissionFuzzTest(data, size);
    return 0;
}
