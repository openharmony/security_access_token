...
#include "gethaptokeninfocompatstub_fuzzer.h"
...
const std::string TEST_BUNDLE_NAME = "gethaptokeninfocompatstub.fuzzer";
}
...
AccessTokenID EnsureValidTokenId()
{
    ...
    bool GetHapTokenInfoCompatStubFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::GetHapTokenInfoCompatStubFuzzTest(data, size);
    return 0;
}
