...
#include "getreqpermissionbynamestub_fuzzer.h"
...
const std::string TEST_BUNDLE_NAME = "getreqpermissionbynamestub.fuzzer";
}
...
AccessTokenID EnsureValidTokenId()
{
    ...
    bool GetKernelPermissionsStubFuzzTestFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::GetKernelPermissionsStubFuzzTestFuzzTest(data, size);
    return 0;
}
