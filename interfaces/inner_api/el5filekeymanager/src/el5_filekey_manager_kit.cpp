...
int32_t El5FilekeyManagerKit::GenerateGroupIDKey(int32_t userId, const std::string &groupID, std::string &keyId)
{
    return El5FilekeyManagerClient::GetInstance().GenerateGroupIDKey(userId, groupID, keyId);
}

int32_t El5FilekeyManagerKit::DeleteGroupIDKey(int32_t userId, const std::string &groupID)
{
    return El5FilekeyManagerClient::GetInstance().DeleteGroupIDKey(userId, groupID);
}
