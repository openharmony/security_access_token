...
enum AccessTokenError {
    ...
    // Implicit numbering below. Never insert a new code in the middle: it
    // renumbers the following codes and misaligns already-released error
    // codes. Append new codes just before the next pinned value; never
    // change a pinned value. Every 10th code is declared explicitly to
    // keep each decade readable at a glance.
    ...
    ERR_CALLBACKS_EXCEED_LIMITATION = 12100010,
    ...
    ERR_PARSE_RAW_DATA_FAILED = 12100030,
    ...
    ERR_BUILD_POLICY_FAILED = 12100040,
    ERR_BUNDLE_ALREADY_EXIST,
    ERR_CHECK_ACL_OR_EDM_FAILED,
    ERR_ALREADY_PREPARE,
    ERR_UID_CREATE_FAILED,
    ERR_KERNEL_OPERATION_FAILED,
    ERR_ALREADY_FINISH_INSTALL,
    ERR_BUNDLE_NOT_EXIST,
    ERR_UID_NOT_EXIST,
    ERR_NOT_CHECK_PERMISSION,
    ERR_HAP_PROVISION_INVALID = 12100050,
    ERR_MIGRATION_COMPLETED,
    ERR_MIGRATION_UID_DUPLICATED,
    ERR_MIGRATION_UID_EXISTED,
    ERR_TOKEN_ACTIVE,
    ERR_INVALID_UID,
    ERR_PERMISSION_REQUEST_TOGGLE_SUBPROFILE_NOT_EXIST,
    ERR_PERMISSION_REQUEST_TOGGLE_STORAGE_MODE_CONFLICT,
    ERR_PERMISSION_REQUEST_TOGGLE_LEGACY_QUERY_CONFLICT,
    ...
    ERR_VERIFY_CANT_OPEN = 12100400,
    ERR_VERIFY_FILE_NOT_EXIST = 12100401,
