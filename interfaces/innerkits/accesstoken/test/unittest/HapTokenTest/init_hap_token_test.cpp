...
/**
 * @tc.name: InitHapTokenSpecsTest015
 * @tc.desc: Initialize ENTERPRISE_NORMAL permission for a enterprise_mdm hap.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InitHapTokenTest, InitHapTokenSpecsTest015, TestSize.Level0)
{
    LOGI(ATM_DOMAIN, ATM_TAG, "InitHapTokenSpecsTest015");
    MockNativeToken mock("foundation");
...
/**
 * @tc.name: InitHapTokenSpecsTest016
 * @tc.desc: Initialize ENTERPRISE_NORMAL permission for a enterprise_normal hap.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InitHapTokenTest, InitHapTokenSpecsTest016, TestSize.Level0)
{
    LOGI(ATM_DOMAIN, ATM_TAG, "InitHapTokenSpecsTest016");
    MockNativeToken mock("foundation");
...
/**
 * @tc.name: InitHapTokenSpecsTest017
 * @tc.desc: Initialize ENTERPRISE_NORMAL permission for a system hap.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InitHapTokenTest, InitHapTokenSpecsTest017, TestSize.Level0)
{
    LOGI(ATM_DOMAIN, ATM_TAG, "InitHapTokenSpecsTest017");
    MockNativeToken mock("foundation");
...
/**
 * @tc.name: InitHapTokenSpecsTest018
 * @tc.desc: Initialize ENTERPRISE_NORMAL permission for a debug hap.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InitHapTokenTest, InitHapTokenSpecsTest018, TestSize.Level0)
{
    LOGI(ATM_DOMAIN, ATM_TAG, "InitHapTokenSpecsTest018");
    MockNativeToken mock("foundation");
...
/**
 * @tc.name: InitHapTokenSpecsTest019
 * @tc.desc: Initialize ENTERPRISE_NORMAL permission for a Non enterprise/system/debug hap.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InitHapTokenTest, InitHapTokenSpecsTest019, TestSize.Level0)
{
    LOGI(ATM_DOMAIN, ATM_TAG, "InitHapTokenSpecsTest019");
    MockNativeToken mock("foundation");
