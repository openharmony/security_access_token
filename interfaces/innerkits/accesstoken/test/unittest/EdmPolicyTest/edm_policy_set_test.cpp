...
HWTEST_F(EdmPolicySetTest, EdmTestGrantPermission001, TestSize.Level0)
{
    ...
    EXPECT_EQ(ERR_PARAM_INVALID, TestCommon::GrantPermissionByTest(tokenID, CUSTOM_SCREEN_CAPTURE,
        PERMISSION_FIXED_BY_ADMIN_POLICY | PERMISSION_PRE_AUTHORIZED_CANCELABLE));
    EXPECT_EQ(ERR_PARAM_INVALID, TestCommon::RevokePermissionByTest(tokenID, CUSTOM_SCREEN_CAPTURE,
        PERMISSION_ADMIN_POLICIES_CANCEL | PERMISSION_COMPONENT_SET));
