...
public:
    ...
    explicit MockHapToken(
        const std::string& bundle, const std::vector<std::string>& reqPerm, bool isSystemApp, int32_t user);
    ~MockHapToken();
...
public:
    ...
    static void TestPrepareManualPermissionStatus(HapPolicyParams& policyParams);
