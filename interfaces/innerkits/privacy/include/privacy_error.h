...
enum PrivacyError {
    ...
    ERR_PRIVACY_TOGGELE_RESTRICTED,
    ERR_PERMISSION_NOT_SUPPORT,
    ERR_DATABASE_OPERATE_FAILED,
    ERR_REMOTE_USING_CONFLICT,
    ERR_PERMISSION_USED_RECORD_SUBPROFILE_NOT_EXIST,
    ERR_PERMISSION_USED_RECORD_STORAGE_MODE_CONFLICT,
    ERR_PERMISSION_USED_RECORD_LEGACY_QUERY_CONFLICT,

    ERR_CAPABILITY_NOT_SUPPORT = 13110000
};
} // namespace AccessToken
} // namespace Security
} // namespace OHOS
