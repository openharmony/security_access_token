...
static const unsigned int TEST_VALID_TOKENID_A = 1;
static const unsigned int TEST_VALID_TOKENID_B = 2;
...
public:
    ...
    class TestCallBack : public OnPermissionUsedRecordCallback {
    public:
