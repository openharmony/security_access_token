...
public:
    ...
    static ani_object CreateCommonError(ani_env* env, int32_t err, const std::string& errMsg = "");
    ...
    static void ThrowEnumError(ani_env* env, const std::string& parameter, const std::string& errMsg);
