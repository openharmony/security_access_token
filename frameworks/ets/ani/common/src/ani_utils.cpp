...
bool GetBoolProperty(ani_env* env, const ani_object& object, const std::string& property, bool& value)
{
    ...
    status = env->Object_CallMethodByName_Boolean(static_cast<ani_object>(ref), "toBoolean", nullptr, &boolValue);
    if (status != ANI_OK) {
...
bool GetIntProperty(ani_env* env, const ani_object& object, const std::string& property, int32_t& value)
{
    ...
    ani_int intValue;
    status = env->Object_CallMethodByName_Int(static_cast<ani_object>(ref), "toInt", nullptr, &intValue);
    if (status != ANI_OK) {
...
bool GetLongProperty(ani_env* env, const ani_object& object, const std::string& property, int64_t& value)
{
    ...
    ani_long longValue;
    status = env->Object_CallMethodByName_Long(static_cast<ani_object>(ref), "toLong", nullptr, &longValue);
    if (status != ANI_OK) {
