...
const static std::vector<std::pair<std::string, bool>> g_permMap = {
    ...
    {"ohos.permission.ACCESS_NEARLINK", true},
    ...
    {"ohos.permission.USE_FRAUD_APP_PICKER",                false},
    {"ohos.permission.PROXY_MESSAGE_AUTH",           false},
    ...
    {"ohos.permission.ACCESS_DDK_USB_SERIAL",               false},
    {"ohos.permission.ACCESS_DDK_SCSI_PERIPHERAL",          false},
    {"ohos.permission.ACCESS_EXTENSIONAL_DEVICE_DRIVER",    false},
    {"ohos.permission.ACCESS_DDK_DRIVERS",                  false},
    ...
    {"ohos.permission.MANAGE_USER_ACCOUNT_INFO",            false},
    ...
    {"ohos.permission.INSTALL_QUICK_FIX_BUNDLE",            false},
    {"ohos.permission.INSTALL_SANDBOX_BUNDLE",              false},
    {"ohos.permission.UNINSTALL_SANDBOX_BUNDLE",            false},
    {"ohos.permission.MANAGE_SYSTEM_AUDIO_EFFECTS",         false},
    {"ohos.permission.START_SYSTEM_DIALOG",                 false},
    {"ohos.permission.ACCESS_STATUSBAR_ICON",               false},
    {"ohos.permission.ACCESS_AI_ABILITY",                   false},
    {"ohos.permission.READ_HEALTH_MOTION",                  false},
    {"ohos.permission.hsdr.REQUEST_HSDR",                   false},
    {"ohos.permission.QUERY_PASSWORD_VAULT_DATA",           false},
    {"ohos.permission.SUBSCRIBE_NOTIFICATION_WINDOW_STATE", false},
    {"ohos.permission.STORAGE_MANAGER_CRYPT",               false},
    {"ohos.permission.READ_FINDSERVICE",                    false},
    {"ohos.permission.GET_NEARLINK_PEER_MAC",               false},
    ...
    {"ohos.permission.SYNC_ASSET_BETWEEN_TRUSTED_ACCOUNT", false},
