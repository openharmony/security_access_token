...
bool ActiveChangeResponseParcel::Marshalling(Parcel& out) const
{
    ...
    RETURN_IF_FALSE(out.WriteString(this->changeResponse.enhancedIdentity));
...
ActiveChangeResponseParcel* ActiveChangeResponseParcel::Unmarshalling(Parcel& in)
{
    ...
    RELEASE_IF_FALSE(
        in.ReadString(activeChangeResponseParcel->changeResponse.enhancedIdentity), activeChangeResponseParcel);
    RELEASE_IF_FALSE(
