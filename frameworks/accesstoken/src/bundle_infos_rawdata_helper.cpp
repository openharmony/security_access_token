...
bool BundleInfosRawdataHelper::WriteToRawData(const std::vector<TrustedBundleInfo>& bundleInfos,
    BundleInfosRawdata& rawData)
{
...
bool BundleInfosRawdataHelper::ReadFromRawData(const BundleInfosRawdata& rawData,
