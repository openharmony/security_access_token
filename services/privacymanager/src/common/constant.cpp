...
const std::map<std::string, int32_t> Constant::PERMISSION_OPCODE_MAP = {
    ...
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOWNLOAD_DIRECTORY_MEDIA_READ", Constant::OP_READ_WRITE_DOWNLOAD_DIRECTORY_MEDIA_READ),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOWNLOAD_DIRECTORY_MEDIA_WRITE", Constant::OP_READ_WRITE_DOWNLOAD_DIRECTORY_MEDIA_WRITE),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOWNLOAD_DIRECTORY_OTHER_READ", Constant::OP_READ_WRITE_DOWNLOAD_DIRECTORY_OTHER_READ),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOWNLOAD_DIRECTORY_OTHER_WRITE", Constant::OP_READ_WRITE_DOWNLOAD_DIRECTORY_OTHER_WRITE),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOCUMENTS_DIRECTORY_MEDIA_READ", Constant::OP_READ_WRITE_DOCUMENTS_DIRECTORY_MEDIA_READ),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOCUMENTS_DIRECTORY_MEDIA_WRITE", Constant::OP_READ_WRITE_DOCUMENTS_DIRECTORY_MEDIA_WRITE),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOCUMENTS_DIRECTORY_OTHER_READ", Constant::OP_READ_WRITE_DOCUMENTS_DIRECTORY_OTHER_READ),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DOCUMENTS_DIRECTORY_OTHER_WRITE", Constant::OP_READ_WRITE_DOCUMENTS_DIRECTORY_OTHER_WRITE),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DESKTOP_DIRECTORY_MEDIA_READ", Constant::OP_READ_WRITE_DESKTOP_DIRECTORY_MEDIA_READ),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DESKTOP_DIRECTORY_MEDIA_WRITE", Constant::OP_READ_WRITE_DESKTOP_DIRECTORY_MEDIA_WRITE),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DESKTOP_DIRECTORY_OTHER_READ", Constant::OP_READ_WRITE_DESKTOP_DIRECTORY_OTHER_READ),
    std::map<std::string, int32_t>::value_type(
        "ohos.permission.READ_WRITE_DESKTOP_DIRECTORY_OTHER_WRITE", Constant::OP_READ_WRITE_DESKTOP_DIRECTORY_OTHER_WRITE),
};
