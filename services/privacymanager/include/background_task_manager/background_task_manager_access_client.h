...
#ifndef PRIVACY_BACKGROUND_TASK_MANAGER_ACCESS_CLIENT_H
#define PRIVACY_BACKGROUND_TASK_MANAGER_ACCESS_CLIENT_H
...
#endif // PRIVACY_BACKGROUND_TASK_MANAGER_ACCESS_CLIENT_H
