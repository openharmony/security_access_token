...
#ifndef PRIVACY_BACKGROUND_TASK_MANAGER_ACCESS_PROXY_H
#define PRIVACY_BACKGROUND_TASK_MANAGER_ACCESS_PROXY_H
...
#endif // PRIVACY_BACKGROUND_TASK_MANAGER_ACCESS_PROXY_H
