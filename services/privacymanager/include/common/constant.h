...
public:
    enum OpCode {
        ...
        OP_CLI_WRITE_ACCESSIBILITY_CONFIG_VISION = 52,
        OP_CLI_WRITE_ACCESSIBILITY_CONFIG_HEARING = 53,
        OP_CLI_WRITE_ACCESSIBILITY_CONFIG_ACTION = 54,
        OP_CLI_SET_HOTSPOT = 55,
        OP_CLI_GET_HOTSPOT = 56,
        OP_CLI_NFC_SWITCH = 57,
        OP_CLI_MANAGE_WIFI_TOGGLE = 58,
        OP_CLI_MANAGE_WIFI_SCAN = 59,
        OP_CLI_MANAGE_WIFI_CONNECT = 60,
        OP_CLI_UNINSTALL_BUNDLE = 61,
        OP_CLI_GET_BUNDLE_INFO_PRIVILEGED = 62,
        OP_CLI_REMOVE_BUNDLE_DATA_AND_CACHE_FILES = 63,
        OP_CLI_MANAGE_DISPOSED_APP_STATUS = 64,
        OP_AGENT_FILE_ACCESS = 65,
        ...
        OP_ACCESS_USER_FULL_DISK_READ = 112,
        OP_ACCESS_USER_FULL_DISK_WRITE = 113,
        //小艺文件权限访问记录
        OP_AGENT_FILE_ACCESS_READ_IMAGEVIDEO = 114,
        OP_AGENT_FILE_ACCESS_WRITE_IMAGEVIDEO = 115,
        OP_AGENT_FILE_ACCESS_READ_AUDIO = 116,
