...
#ifndef ACCESSTOKEN_DB_CONSISTENCY_TEST_H
#define ACCESSTOKEN_DB_CONSISTENCY_TEST_H
...
class AccessTokenDbConsistencyTest : public testing::Test {
public:
...
#endif // ACCESSTOKEN_DB_CONSISTENCY_TEST_H
