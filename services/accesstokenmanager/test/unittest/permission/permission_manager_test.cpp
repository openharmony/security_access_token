...
static PermissionStatus g_infoManagerTestStateE = {
    .grantStatus = PERMISSION_GRANTED,
    .grantFlag = 1
};
...
static AccessTokenID CreateTempHapTokenInfo()
{
    ...
    g_infoManagerTestStateC.permissionName = "ohos.permission.CAMERA";
    g_infoManagerTestStateC.grantStatus = PERMISSION_DENIED;
    g_infoManagerTestStateD.permissionName = "ohos.permission.MICROPHONE";
    g_infoManagerTestStateD.grantStatus = PERMISSION_DENIED;
    g_infoManagerTestStateE.permissionName = "ohos.permission.CUSTOM_SCREEN_CAPTURE";
    g_infoManagerTestStateE.grantStatus = PERMISSION_DENIED;
    static HapPolicy infoManagerTestPolicyPrams = {
        ...
        .permStateList = {
            ...
            g_infoManagerTestStateB,
            g_infoManagerTestStateC,
            g_infoManagerTestStateD,
            g_infoManagerTestStateE
        }
    };
