...
{
    ACCESSTOKEN_LOG_INFO(LABEL, "%{public}s called, remoteDeviceID: %{private}s, remoteTokenID: %{public}d",
...
{
    ACCESSTOKEN_LOG_INFO(LABEL, "%{public}s called, deviceID: %{private}s, token id %{public}d",
