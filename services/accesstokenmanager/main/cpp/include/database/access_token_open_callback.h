...
static constexpr const int32_t DATABASE_VERSION_13 = 13;
#endif
...
private:
    ...
    int32_t CreateVersionTwelveTable(NativeRdb::RdbStore& rdbStore);
    ...
    int32_t AddModeColumn(NativeRdb::RdbStore& rdbStore, AtmDataType type);
