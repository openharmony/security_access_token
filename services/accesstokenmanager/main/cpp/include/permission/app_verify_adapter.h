...
public:
    ...
    IAppVerifyAdapter(const IAppVerifyAdapter&) = delete;
    IAppVerifyAdapter& operator=(const IAppVerifyAdapter&) = delete;
    IAppVerifyAdapter(IAppVerifyAdapter&&) = delete;
    IAppVerifyAdapter& operator=(IAppVerifyAdapter&&) = delete;
