...
static constexpr int TOKEN_RANDOM_MASK = (1 << 24) - 1;
...
public:
    ...
    AccessTokenID CreateAndRegisterTokenId(ATokenTypeEnum type);
...
private:
    ...
    AccessTokenID CreateTokenId(ATokenTypeEnum type) const;
