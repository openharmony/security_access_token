 ...
 */
HWTEST_F(CJsonUtilsTest, CreateJsonFromStringTest001, TestSize.Level1)
{
    std::string test;
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, PackJsonToStringTest001, TestSize.Level1)
{
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, GetObjFromJsonTest001, TestSize.Level1)
{
    std::string test;
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, GetArrayFromJsonTest001, TestSize.Level1)
{
    std::string test;
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, GetStringFromJsonTest001, TestSize.Level1)
{
    std::string test;
    std::string res;
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, GetIntFromJsonTest001, TestSize.Level1)
{
    std::string test;
    int32_t res;
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, GetUnsignedIntFromJsonTest001, TestSize.Level1)
{
    std::string test;
    uint32_t res;
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, GetBoolFromJsonTest001, TestSize.Level1)
{
    std::string test;
    bool res;
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, GetBoolFromJsonTest002, TestSize.Level1)
{
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, AddObjToJsonTest001, TestSize.Level1)
{
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, AddObjToArrayTest001, TestSize.Level1)
{
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, AddStringToJsonTest001, TestSize.Level1)
{
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, AddBoolToJsonTest001, TestSize.Level1)
{
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, AddIntToJsonTest001, TestSize.Level1)
{
 ...
 * @tc.require: TDD coverage
 */
HWTEST_F(CJsonUtilsTest, AddUnsignedIntToJsonTest001, TestSize.Level1)
{
